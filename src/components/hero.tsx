...
export function Hero() {
  ...
  const inkColor = isDark ? "hsl(0 0% 100%)" : "hsl(0 0% 10%)";
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className="fixed top-0 left-0 right-0 z-50 px-6 py-6 backdrop-blur-md"
        style={{
          backgroundColor: isDark ? "hsla(0, 0%, 0%, 0.55)" : "hsla(0, 0%, 98%, 0.55)",
        }}
      >
      ...
      <main className="relative min-h-screen flex flex-col">
          ...
          <div className="relative text-center">
            <div>
              <BlurText
                ...
                animateBy="letters"
                direction="top"
                className="font-display font-bold text-[64px] sm:text-[100px] md:text-[130px] lg:text-[155px] leading-[0.75] tracking-tighter uppercase justify-center whitespace-nowrap"
                style={{ color: inkColor }}
              />
            </div>
            <div>
        ...
        <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 lg:bottom-32 xl:bottom-36 left-1/2 -translate-x-1/2 w-full px-6">
          <div className="flex justify-center">
            <BlurText
              text="Building full-stack marketplaces where AI, code, and real-world logistics meet."
              delay={150}
              animateBy="words"
              direction="top"
              className="font-tagline text-[15px] sm:text-[18px] md:text-[20px] lg:text-[22px] text-center max-w-2xl transition-colors duration-300 text-neutral-500 hover:text-black dark:hover:text-white"
            />
          </div>
        </div>
